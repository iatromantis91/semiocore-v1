# semiocore.biomed.trajectory_comparator.v1

## Purpose
**Trajectory comparator regime**. Two-point comparator over pre/post proxy scores. Encodes a minimal longitudinal replay target.
