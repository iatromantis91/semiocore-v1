# semiocore.biomed.inflammation_proxy.v1

## Purpose
**Inflammation proxy regime**. Proxy inflammatory burden score (normalized). Positive suggests elevated inflammatory load.
