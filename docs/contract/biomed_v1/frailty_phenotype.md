# semiocore.biomed.frailty_phenotype.v1

## Purpose
**Frailty-style phenotype regime**. Frailty-style phenotype proxy score (normalized). Uses binarization under a small offset.
